...
export default function AnalyticsGeoCtaSection() {
    return (
            ...
            <div className="cta-band">
                ...
                <div style={{ position: 'relative', zIndex: 2 }}>
                    ...
                    <h2 className="display" style={{ marginTop: 18, maxWidth: 720, marginInline: 'auto' }}>
                        Solicita una demo del dashboard
                    </h2>
                    <p style={{ color: 'var(--fg-dim)', fontSize: 17, maxWidth: 560, margin: '22px auto 0' }}>
                        Agenda una demo personalizada de 30 minutos y te mostramos el
                        dashboard configurado con tus propias métricas. Sin compromiso,
                        sin tecnicismos innecesarios.
                    </p>
                    <div style={{ marginTop: 32, display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
                        <a className="btn-pill" href="/contacto/">Agenda tu demo personalizada <ArrowUpRight /></a>
                    </div>
                </div>
            </div>
        </section>
