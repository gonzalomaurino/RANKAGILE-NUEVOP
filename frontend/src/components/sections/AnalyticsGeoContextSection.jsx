...
export default function AnalyticsGeoContextSection() {
  ...
  const bullets = t('analytics.geoContext.bullets', { returnObjects: true });
  return (
    <section className="geo-page-section">
      <span className="geo-page-eyebrow">{t('analytics.geoContext.eyebrow')}</span>
      <div className="geo-urgent">
        <div className="geo-urgent-copy">
          <h2 className="geo-page-h2">{t('analytics.geoContext.h2')}</h2>
          ...
          <a className="btn-ghost" href={`${prefix}/contacto/`}>{t('analytics.geoContext.cta')}</a>
        </div>
