export default function GeoComparisonSection() {
  return (
    <section className="geo-section">
      <span className="geo-eyebrow">Comparativa técnica</span>
      <h2 className="geo-h2">SEO vs GEO vs AEO: ¿en qué se diferencian?</h2>
      <div className="geo-grid-3">
        <article className="geo-card">
          <p className="geo-card-title">SEO — Search Engine Optimization</p>
          <p className="geo-card-body">
        ...
        <article className="geo-card">
          <p className="geo-card-title is-accent">GEO — Generative Engine Optimization</p>
          <p className="geo-card-body">
        ...
        <article className="geo-card">
          <p className="geo-card-title">AEO — Answer Engine Optimization</p>
          <p className="geo-card-body">
