export default function GeoDefinitionSection() {
  return (
    <section className="geo-section">
      <span className="geo-eyebrow">Definición operativa</span>
      <h2 className="geo-h2">¿Qué es el GEO (Generative Engine Optimization)?</h2>
      <p className="geo-p">
      ...
      <h3 className="geo-h3">¿Cómo decide una IA qué marca mencionar?</h3>
      <p className="geo-p">Los modelos generativos priorizan marcas que:</p>
