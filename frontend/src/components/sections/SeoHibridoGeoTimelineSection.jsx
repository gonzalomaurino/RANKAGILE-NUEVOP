...
export default function SeoHibridoGeoTimelineSection() {
  ...
  const items = t('seoHibrido.geoTimeline.items', { returnObjects: true });
  return (
    <section className="geo-page-section">
      <span className="geo-page-eyebrow">{t('seoHibrido.geoTimeline.eyebrow')}</span>
      <h2 className="geo-page-h2">{t('seoHibrido.geoTimeline.h2')}</h2>
